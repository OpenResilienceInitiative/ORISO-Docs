...
All database pods should show status `Running` and `1/1` ready. If not, check [Deploy Infrastructure](/betrieb/deployment/deploy-infrastructure).
</Callout>
...
- [Deploy Infrastructure](/betrieb/deployment/deploy-infrastructure) - If databases not yet deployed
- [Configure Keycloak](/betrieb/deployment/configure-keycloak) - Import Keycloak realm
