...
- **External:** `https://auth.oriso.org` (via Ingress)
</Callout>
...
1. Open browser and navigate to: `https://auth.oriso.org/admin/` (or `http://YOUR_SERVER_IP:8080/admin/` if Ingress not configured)
...
- [Setup Databases](/betrieb/deployment/setup-databases) - Configure MariaDB and MongoDB
- [Deploy Backend Services](/betrieb/deployment/deploy-backend-services) - Deploy microservices
