...
- **External:** `https://auth.example.org` (via Ingress)
</Callout>
...
1. Open browser and navigate to: `https://auth.example.org/admin/` (or `http://YOUR_SERVER_IP:8080/admin/` if Ingress not configured)
