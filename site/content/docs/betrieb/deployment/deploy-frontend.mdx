...
- **External:** `https://admin.oriso.org`
...
- [Deploy Ingress](/betrieb/deployment/deploy-nginx) - Configure external access
- [Post-Deployment](/betrieb/configuration-und-testing/post-deployment) - Complete post-deployment steps
- [Verification Testing](/betrieb/configuration-und-testing/verification-testing) - Test frontend functionality
