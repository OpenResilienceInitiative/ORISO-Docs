...
This guide assumes services are already deployed. If not, see [Deploy Infrastructure](/betrieb/deployment/deploy-infrastructure).
</Callout>
...
curl -s https://api.oriso.org/actuator/health
```
...
- [Deploy Frontend](/betrieb/deployment/deploy-frontend) - Deploy frontend applications
- [Post-Deployment](/betrieb/configuration-und-testing/post-deployment) - Complete post-deployment steps
- [Verification Testing](/betrieb/configuration-und-testing/verification-testing) - Test all services
