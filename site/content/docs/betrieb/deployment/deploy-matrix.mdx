...
curl -s https://matrix.oriso.org/_matrix/client/versions

# Check Discovery service
curl -s http://91.99.219.182/.well-known/matrix/server

# Check Element.io (if deployed)
curl -I https://element.oriso.org
```
...
- **External:** `https://matrix.oriso.org`
...
- **External:** `https://element.oriso.org` or `http://91.99.219.182:8087`
...
- [Verification Testing](/betrieb/configuration-und-testing/verification-testing) - Test Matrix functionality
