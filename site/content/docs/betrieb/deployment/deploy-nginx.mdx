...
curl -I https://matrix.example.org
```
...
- `api.example.org` → `$SERVER_IP`
- `app.example.org` → `$SERVER_IP`
- `admin.example.org` → `$SERVER_IP`
- `auth.example.org` → `$SERVER_IP`
- `matrix.example.org` → `$SERVER_IP`
