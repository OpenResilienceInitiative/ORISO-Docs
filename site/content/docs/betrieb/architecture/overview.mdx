...
- [Architecture: Backend Services](/betrieb/architecture/backend) - Detailed backend architecture
- [Architecture: Frontend](/betrieb/architecture/frontend) - Frontend architecture
- [Architecture: Data Layer](/betrieb/architecture/data) - Database architecture
- [Architecture: Infrastructure](/betrieb/architecture/infra) - Infrastructure details
