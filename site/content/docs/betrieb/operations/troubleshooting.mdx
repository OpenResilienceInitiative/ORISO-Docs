...
See [Configure Keycloak](/betrieb/deployment/configure-keycloak) for detailed instructions.
...
curl -I https://api.oriso.org/actuator/health
```
...
- [Post-Deployment Configuration](/betrieb/configuration-und-testing/post-deployment) - Verification steps
- [Configure Keycloak](/betrieb/deployment/configure-keycloak) - Keycloak configuration
