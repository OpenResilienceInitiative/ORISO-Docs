...
- [Install Required Software](/betrieb/getting-started/install-software) - Install Kubernetes and Helm
- [Setup Kubernetes](/betrieb/getting-started/setup-kubernetes) - Configure Kubernetes cluster
- [Deploy Infrastructure](/betrieb/deployment/deploy-infrastructure) - Deploy all services
