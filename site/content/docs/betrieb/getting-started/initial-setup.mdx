...
---
Complete the initial server configuration steps to prepare your Ubuntu server for ORISO Platform v3.0.0 deployment on Kubernetes with Helm charts.
...
- [Network & Firewall Configuration](/betrieb/getting-started/network-firewall) - Configure network and firewall settings
- [Install Required Software](/betrieb/getting-started/install-software) - Install Docker and Kubernetes
