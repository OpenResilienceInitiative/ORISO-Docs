...
description: Belegte Compliance und Architekturentscheidungen der ORISO-Plattform — aus dem Quellcode abgeleitet, versioniert im Repository ORISO-Docs.
---
...
## Drei Regeln, nach denen die Texte geschrieben sind
