...
---
> **Outdated — archived.** A snapshot of the graph merge of May 2026. The current mechanism, and the numbers that go with it, are described in [How we keep the docs honest](/plattform/knowledge-graphs/understand-anything); the live graphs are at [understand.oriso.org](https://understand.oriso.org/).
...
- Review Needs verification items in [super-graph-explorer](/plattform/archive/super-graph-explorer).
