...
---
> **Outdated — archived.** This page describes a Rocket.Chat-based flow that the codebase no longer contains; chat runs on Matrix ([ADR-004](/decisions/adr-004), [ADR-017](/decisions/adr-017)). Use [Backend services](/plattform/core-systems/backend-services) and [Authentication and Keycloak](/plattform/core-systems/authentication-and-keycloak) instead. Kept for history only.
