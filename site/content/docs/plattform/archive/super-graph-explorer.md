...
---
> **Outdated — archived.** A dump of the May 2026 graph merge, superseded by the live dashboards at [understand.oriso.org](https://understand.oriso.org/). See [How we keep the docs honest](/plattform/knowledge-graphs/understand-anything).
...
- Detailed markdown: [super-graph-detailed](/plattform/archive/super-graph-detailed)
- Artifact inventory: [understand-anything-inventory](/plattform/archive/understand-anything-inventory)

## By Repository

- [ORISO-Frontend](/plattform/archive/super-graph-detailed#oriso-frontend) — 1967 nodes, 4204 edges
- [ORISO-Admin](/plattform/archive/super-graph-detailed#oriso-admin) — 776 nodes, 1547 edges
- [ORISO-UserService](/plattform/archive/super-graph-detailed#oriso-userservice) — 2295 nodes, 3854 edges
- [ORISO-AgencyService](/plattform/archive/super-graph-detailed#oriso-agencyservice) — 623 nodes, 835 edges
- [ORISO-ConsultingTypeService](/plattform/archive/super-graph-detailed#oriso-consultingtypeservice) — 470 nodes, 515 edges
- [ORISO-TenantService](/plattform/archive/super-graph-detailed#oriso-tenantservice) — 380 nodes, 623 edges
- [ORISO-Database](/plattform/archive/super-graph-detailed#oriso-database) — 192 nodes, 312 edges
- [ORISO-Keycloak](/plattform/archive/super-graph-detailed#oriso-keycloak) — 152 nodes, 247 edges
- [ORISO-Kubernetes](/plattform/archive/super-graph-detailed#oriso-kubernetes) — 339 nodes, 588 edges
