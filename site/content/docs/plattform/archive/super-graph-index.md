...
---
> **Outdated — archived.** Describes the merge-only super graph of May 2026. See [How we keep the docs honest](/plattform/knowledge-graphs/understand-anything) and [understand.oriso.org](https://understand.oriso.org/).
...
- [Detailed graph view](/plattform/archive/super-graph-detailed)
- [Explorer index](/plattform/archive/super-graph-explorer)
- [Repository map](/plattform/flows-und-reference/repository-map)
- [Understand-Anything inventory](/plattform/archive/understand-anything-inventory)
