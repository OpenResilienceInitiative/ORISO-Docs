...
| Diagram | Page |
| --- | --- |
| Service landscape, with call directions | [Architecture](/plattform/start-here/architecture) |
| Login and token flow, Keycloak to service | [Authentication and Keycloak](/plattform/core-systems/authentication-and-keycloak) |
| Tenant resolution fallback chain | [Authentication and Keycloak](/plattform/core-systems/authentication-and-keycloak) |
| How to read a service, contract to repository | [Backend services](/plattform/core-systems/backend-services) |
| Data ownership across the stores | [Database and data model](/plattform/core-systems/database-and-data-model) |
| Deploy path, pull request to pod | [Kubernetes deployment](/plattform/core-systems/kubernetes-deployment) |
| Browser request path, component to service | [Frontend and Admin](/plattform/core-systems/frontend-admin-overview) |
| How the code graphs are built | [How we keep the docs honest](/plattform/knowledge-graphs/understand-anything) |
