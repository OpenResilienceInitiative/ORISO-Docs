...
[how we keep the docs honest](/plattform/knowledge-graphs/understand-anything). "Endpoints it exposes" counts
...
- [Architecture](/plattform/start-here/architecture) — the call graph
- [Authentication and Keycloak](/plattform/core-systems/authentication-and-keycloak) — the security pieces
- [Database and data model](/plattform/core-systems/database-and-data-model) — the owned schemas
- [Install and run locally](/plattform/start-here/install-and-run-locally) — how to start one
