...
6. Optionally types a zip code and topic to refine matching (Path B, see [Pincode Chat](/produkt/core-features/pincode-chat)).
...
<Callout type="warn">
**Reality check** (also see [4.1](/produkt/core-features/transcription)): there is **no AI-driven transcript pipeline** in production today. This flow describes (a) the chat-history flow that exists today via Matrix, and (b) the planned AI-assisted case-note feature.
</Callout>
