...
- **Push** (planned via Matrix Push Gateway — see [Figma analysis §4.7](/produkt/design-und-quality/figma-analysis-2026-05#47-notification-channels)).
...
Per-chat-type controls (see [Roles & Permissions §3.7](/produkt/architecture-und-roles/roles-permissions#37-per-chat-type-permissions-matrix)):
...
- [Group Chats](/produkt/core-features/group-chats) — Help Requests live in chat-room settings.
- [Handover](/produkt/core-features/handover) — pairs with system messages and notifications.
- [Roles & Permissions](/produkt/architecture-und-roles/roles-permissions).
