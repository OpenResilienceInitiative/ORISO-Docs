...
<Callout>
The May-2026 Figma confirms that ORISO is **not 1-1 only**. Group chats are first-class — with their own type taxonomy, permission profile, and counselor-only collaboration tools. See the [Figma Analysis](/produkt/design-und-quality/figma-analysis-2026-05) for the underlying screens.
</Callout>
...
Decision pending — see [Figma analysis §4.3](/produkt/design-und-quality/figma-analysis-2026-05#43-multi-recipient-send--server-side-enforcement).
...
| **Hilfe Anfragen** | `⇧Ä` | Internal/external escalation — see [Notifications & Help Requests](/produkt/core-features/notifications). |
...
| **Chat Zusammenfassen** | `⇧Ü` | AI summary — see [AI Tools](/produkt/core-features/ai-tools). |
...
For the full catalogue see [Edge Cases](/produkt/design-und-quality/edge-cases). Key group-chat ones:

- **Client deletes themselves mid-group-chat** → see [9.1.8](/produkt/design-und-quality/edge-cases#918-client-deletes-self-from-group-chat).
...
- [Live Chat (4.2)](/produkt/core-features/live-chat) — the 1-1 entry point most groups grow out of.
- [AI Tools (4.6)](/produkt/core-features/ai-tools) — Summary, Mark/Blur.
- [Notifications & Help Requests (4.7)](/produkt/core-features/notifications).
- [Roles & Permissions](/produkt/architecture-und-roles/roles-permissions) — per-chat-type permission matrix.
- [Figma Analysis](/produkt/design-und-quality/figma-analysis-2026-05) — the source for everything on this page.
