...
<Callout>
How clients join a self-help group (*Gesprächskreis*) through its invite link, and the rule that
joining opens no counselling enquiry, are described in
[Self-Help Groups — Invite Link and Joining (4.10)](/product/features/self-help-groups).
</Callout>
