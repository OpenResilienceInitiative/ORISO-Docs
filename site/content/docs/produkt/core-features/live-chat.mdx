...
<Callout>
**Live Chat is the 1-1 entry point**, but a session does not stay 1-1 forever. A counselor in an active room can click **Invite more people** (`⇧I`) to add peers, supervisors, or other clients — the room then becomes a [Group Chat](/produkt/core-features/group-chats). The May-2026 Figma also confirms that **video calls** (LiveKit) embed inside the same room rather than spawning a separate session.
</Callout>
...
For the full edge-case catalogue, see [Edge Cases](/produkt/design-und-quality/edge-cases).
...
- [Group Chats & Multi-Recipient Send (4.5)](/produkt/core-features/group-chats) — what a 1-1 chat becomes after `Invite more people`.
- [AI Tools (4.6)](/produkt/core-features/ai-tools) — Mark, Blur, Summary inside the chat.
- [Case Handover (4.7)](/produkt/core-features/handover) — transferring this chat to another counselor.
- [Notifications & Help Requests (4.8)](/produkt/core-features/notifications) — escalation from inside the chat.
- [Pincode-Based Chat & Access](/produkt/core-features/pincode-chat)
- [Session Management](/produkt/core-features/session-management)
- [User Flow: Live Chat Activation](/produkt/flows-und-internals/user-flows#55-live-chat-activation)
- [UI/UX Interpretation](/produkt/design-und-quality/ui-ux)
- [Figma Analysis (May 2026)](/produkt/design-und-quality/figma-analysis-2026-05)
