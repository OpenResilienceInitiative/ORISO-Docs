...
<Callout type="warn">
**This page records the May-2026 Figma proposal, not the built feature.** It is kept for the
design history. What the platform actually does — getting and giving a case, the current reason
taxonomy, and who has to agree — is on [Case Handover — Getting and Giving a Case](/product/features/case-handover).
Two points below have since been decided differently: the previous counsellor is **not** removed
from the conversation, and reasons no longer name illness or any other health information.
</Callout>
