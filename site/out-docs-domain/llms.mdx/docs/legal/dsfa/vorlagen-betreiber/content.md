# Vorlagen für den Betreiber (/legal/dsfa/vorlagen-betreiber)
...
## 4 — Akteure und Governance (`governance`) [#4--akteure-und-governance-governance]
...
## 5 — Verantwortlichkeit (`accountability`) [#5--verantwortlichkeit-accountability]
...
## 8.1 — Identitätsüberprüfung (`identityCheck`) [#81--identitätsüberprüfung-identitycheck]
...
## 8.3 — Datenschutzhinweise und Informationswege (`informationChannels`) [#83--datenschutzhinweise-und-informationswege-informationchannels]
...
## 8.11 — Eskalationskette und Datenweitergabe an Ermittlungsbehörden (`escalationChain`) [#811--eskalationskette-und-datenweitergabe-an-ermittlungsbehörden-escalationchain]
...
## 9.1 — Legitimer Zweck (`proportionalityPurpose`) [#91--legitimer-zweck-proportionalitypurpose]
...
## 9.2 — Geeignetheit (`proportionalitySuitability`) [#92--geeignetheit-proportionalitysuitability]
...
## 9.3 — Erforderlichkeit (`proportionalityNecessity`) [#93--erforderlichkeit-proportionalitynecessity]
...
## 9.4 — Angemessenheit (`proportionalityBalance`) [#94--angemessenheit-proportionalitybalance]
...
## 2 — Ergebnisabsatz der Schwellwertanalyse (`resultParagraph`) [#2--ergebnisabsatz-der-schwellwertanalyse-resultparagraph]
...
## A — Anlagenverzeichnis (`annexIndex`) [#a--anlagenverzeichnis-annexindex]
