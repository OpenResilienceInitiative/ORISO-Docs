# ADR-002: Silent room membership with an access-control confidentiality curtain (not E2EE) (/decisions/adr-002)
...
* **Related:** [ADR-001](/decisions/adr-001) (modalities as modules); `ORISO-UserService/CONTEXT.md`; `ORISO-Frontend/CONTEXT.md` (Handover); UserService `UnauthorizedMembersProvider`, `AgencyPreAssignmentRoomService`, `AssignEnquiryFacade`, `MatrixRoomClient`, `SessionSupervisorFacade`
...
## Relationship to the in-flight Case Handover work (cross-checked 2026-06-25) [#relationship-to-the-in-flight-case-handover-work-cross-checked-2026-06-25]
...
* **Technical eligibility is assumed, not implemented** — `CaseHandoverService.requestAccess`
  ...
  membership; it only works because rooms are currently unencrypted. [ADR-002](/decisions/adr-002)'s "real
...
## Reveal lifecycle (decided 2026-06-25) [#reveal-lifecycle-decided-2026-06-25]
...
## Resolved (design session 2026-06-25) [#resolved-design-session-2026-06-25]
...
* **Department (agency × topic)*&#x2A; is first-class and carries imprint/DPP — see &#x2A;*[ADR-003](/decisions/adr-003)**.
...
## Implementation notes (added 2026-07-30, after #905 made §1 live) [#implementation-notes-added-2026-07-30-after-905-made-1-live]
