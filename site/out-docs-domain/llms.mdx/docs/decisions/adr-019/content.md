# ADR-019 — Media scanning via matrix-content-scanner, fail-closed, pluggable AI check (/decisions/adr-019)



**Status:** Accepted · &#x2A;*Date:** 2026-07-18

> **Renumbered 2026-08-08 from [ADR-014](/decisions/adr-014) (ORISO-Docs#73).** Two accepted ADRs both carried
> the number 014, so every cross-reference to "[ADR-014](/decisions/adr-014)" was ambiguous. The later of the two —
