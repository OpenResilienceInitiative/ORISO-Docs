# ADR-010: Platform-controlled per-Träger allowlist for the Erscheinungsbild (Appearance/Theme) section (/decisions/adr-010)
...
## Testing (what this needs) [#testing-what-this-needs]
...
## Open (pending Frank) [#open-pending-frank]
