...
1. Access Keycloak admin: `https://auth.example.org/admin/`
...
|---------|-----|-------------|
| Frontend | https://app.example.org | User portal |
| Admin | https://admin.example.org | Admin panel |
| API | https://api.example.org | Backend API |
| Auth | https://auth.example.org | Keycloak |
| Matrix | https://matrix.example.org | Matrix Synapse |
| Health Dashboard | http://YOUR_SERVER_IP:9001 | Health monitoring |
| SignOZ | http://YOUR_SERVER_IP:3001 | Observability |
